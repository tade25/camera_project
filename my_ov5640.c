...
static struct reg_value ov5640_init_setting_30fps_VGA[] = {
	...
	{0x3008, 0x02}, {0x3034, 0x18}, {0x3035, 0x11},
	{0x3036, 0x38}, {0x3037, 0x13},
};
...
static void OV5640_Init(struct i2c_client *client)
{
    ...
    for(i = 0;i < len;i++) {
        (void)i2c_ov5640_write(client, ov5640_global_init_setting[i].reg,\
				&ov5640_global_init_setting[i].reg_val, 1);
    }

    len = MY_OV5640_ARRAY_SIZE(ov5640_init_setting_30fps_VGA);
    for(i = 0;i < len;i++) {
        (void)i2c_ov5640_write(client, ov5640_init_setting_30fps_VGA[i].reg,\
...
static int my_ov5640_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	struct reg_value reg_data[4] = {
		{0x3820, 0x46}, {0x3821, 0x01},
